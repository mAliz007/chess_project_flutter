...
import '../game/captured_pieces_hud.dart';
...
class LocalPlayerCard extends StatelessWidget {
 ...
 final String fen;
 final String capturedBy; // 'player' or 'ai' (reusing logic from CapturedPiecesHUD)
   ...
   child: Column(
    children: [
     ...
     Align(
      ...
      child: CapturedPiecesHUD(fen: fen, capturedBy: capturedBy),
     ),
    ],
   ),
  );
